    ...
    <div className="nav-bar flex flex-row justify-between w-full">
      <Link href={'/'}>
        ...
        <div className=" flex flex-row items-center gap-5">
          {session?.status == 'authenticated' && <span className="cursor-pointer" onClick={() => signOut()}><MdOutlineLogout /></span>}
          <div className="profile-picture-container w-10 h-10">
            <Link href={'/login'}>
            <a>
            {userPic ? <Image
              src={userPic || 'https://d1fdloi71mui9q.cloudfront.net/ZSjKjeQTyKnJHLCJs8LQ_G8UirQ9PGI1aVm7s'}
